...
class Methods:
    ...
    def user_balance(self, **kwargs) -> dict:
        ...
        response = requests.get("http://api.kopeechka.store/user-balance", params=query)
    ...
    def mailbox_get_email(self, site: str, mail_type: str = "", regex: str = "",
        ...
        response = requests.get("http://api.kopeechka.store/mailbox-get-email", params=query)
        return response.json()
    ...
    def mailbox_get_message(self, task_id: int, full: int = "", **kwargs) -> dict:
        ...
        response = requests.get("http://api.kopeechka.store/mailbox-get-message", params=query)
        return response.json()
    ...
    def mailbox_cancel(self, task_id: int, **kwargs) -> dict:
        ...
        response = requests.get("http://api.kopeechka.store/mailbox-cancel", params=query)
        return response.json()
    ...
    def mailbox_reorder(self, site: str, email: str, regex: str = "", subject: str = "", password: int = "",
        ...
        response = requests.get("http://api.kopeechka.store/mailbox-reorder", params=query)
        return response.json()
    ...
    def mailbox_get_fresh_id(self, site: str, email: str, **kwargs) -> dict:
        ...
        response = requests.get("http://api.kopeechka.store/mailbox-get-fresh-id", params=query)
        return response.json()
